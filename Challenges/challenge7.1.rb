# Wrapper Function that will need ot be changed, but only in this spot!
def third_party_dependency_wrapper(a, b, c)
    return third_party_dependency_that_changes_very_frequently(b, a, c)
end

def myfunction1(a, b, c)
  return third_party_dependency_wrapper(a, b, c)
end
